//
//  DQMRequestBaseViewController.m
...
@interface DQMRequestBaseViewController ()

@property (nonatomic, strong) Reachability *reachHost;

@end

@implementation DQMRequestBaseViewController
...
#pragma mark - DQMRequestBaseViewControllerDelegate
